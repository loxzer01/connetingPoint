...
function MvvSection() {
  ...
  } = t("about.missionVisionValues") as unknown as {
    mission: { title: string; description: string };
    vision: { title: string; description: string };
    values: { title: string; intro: string; items: string[] };
  };
...
function DataDrivenSection() {
  ...
  } = t("about.dataDriven") as unknown as {
    title: string;
    description: string;
    cards: Array<{ title: string; description: string}>;
  };
  ...
  const icons = [
    <FaInfoCircle size={40} className="text-[#4a6cf7]" key={0} />,
    <FaCogs size={40} className="text-[#4a6cf7]" key={1} />,
    <FaLink size={40} className="text-[#4a6cf7]" key={2} />,
    <FaHeadset size={40} className="text-[#4a6cf7]" key={3} />,
    <FaSyncAlt size={40} className="text-[#4a6cf7]" key={4} />,
  ];
